...
public static class RemoteInput
{
    ...
    public static KeyCode Y1 => IsMac ? KeyCode.Joystick1Button4 : KeyCode.Joystick1Button4;
    public static KeyCode Y2 => IsMac ? KeyCode.Joystick2Button4 : KeyCode.Joystick2Button4;
